...
execute unless score @s 6si_gu.uuid.0 matches -2147483648.. run function 6si_gu:zzz/store_uuid

execute store result score 0= 6si_gu.main run scoreboard players operation 1= 6si_gu.main = @s 6si_gu.uuid.0
...
execute store result score 0= 6si_gu.main run scoreboard players operation 1= 6si_gu.main = @s 6si_gu.uuid.1
...
execute store result score 0= 6si_gu.main run scoreboard players operation 1= 6si_gu.main = @s 6si_gu.uuid.2
...
execute store result score 0= 6si_gu.main run scoreboard players operation 1= 6si_gu.main = @s 6si_gu.uuid.3
